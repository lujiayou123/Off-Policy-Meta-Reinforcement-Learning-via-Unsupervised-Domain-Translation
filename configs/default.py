...
default_config = dict(
    ...
    algo_params=dict(
        ...
        embedding_batch_size=128, # number of transitions in the context batch (default 64)
        embedding_mini_batch_size=128, # number of context transitions to backprop through (should equal the arg above except in the recurrent encoder case)
