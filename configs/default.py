...
default_config = dict(
    ...
    algo_params=dict(
        ...
        num_iterations=500, # number of data sampling / training iterates, default 500
        num_initial_steps=2000, # number of transitions collected per task before training
        num_exploration_steps=256,#number of exploration steps(num_exploration_steps*num_task_inference)
        ...
        num_train_steps_per_itr=4000, # number of meta-gradient steps taken per iteration, default 2000
